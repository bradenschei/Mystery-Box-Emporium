...
<body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div id="home">
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto nav-pills">
                    <li class="nav-item">
                        <a class="nav-link" id="pill-style" href="#home">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pill-style" href="catalog.html">Catalog</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pill-style" href="#resources">Resources</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pill-style" href="#clients">Clients</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pill-style" href="#contact">Contact</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="caption text-center">
            <h1>The Newest Mystery in Fashion</h1>
            <h3>Mystery Box Emporium</h3>
            <a class="btn btn-outline-light btn-lg" href="#catalog">Get Started</a>
        </div>
    ...
    <div id="clients" class="offset">
        ...
        <div class="col-12 narrow text-center">
            ...
            <a class="btn btn-secondary  btn-md" href="http://bit.ly/advanced-bootstrap-course" target="_blank">Bootstrap
                Course</a>
        </div>
    </div>
    <!--End Clients Section-->
